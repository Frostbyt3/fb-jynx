Config = {
    ...
    --blipLocation = vector3(223.81, -816.15, 74.22),
    ...
    NPCLocations = {
        ...
        DropLocations = {
            ...
            [42] = vector4(2502.57, 4098.76, 37.63, 154.2), -- Red Roses Bar
    ...
    PZLocations = {
        ...
        DropLocations = {
            ...
            [24] = {coord = vector4(409.14, -998.76, 28.67, 356.59), height = 21.2, width = 4.2, heading = 356, minZ = 28, maxZ = 30},
            [25] = {coord = vector4(200.04, -223.58, 53.38, 249.8), height = 21.2, width = 4.2, heading = 249, minZ = 53, maxZ = 55},
            [26] = {coord = vector4(321.31, -268.55, 53.21, 253.73), height = 21.2, width = 4.2, heading = 253, minZ = 52.5, maxZ = 55},
            [27] = {coord = vector4(292.26, 176.92, 103.53, 68.53), height = 21.2, width = 4.2, heading = 68, minZ = 102.5, maxZ = 105},
            [28] = {coord = vector4(-565.81, 268.23, 82.32, 87.88), height = 21.2, width = 4.2, heading = 87, minZ = 81.5, maxZ = 84},
            [29] = {coord = vector4(-2981.2, 389.8, 14.27, 355.34), height = 21.2, width = 4.2, heading = 355, minZ = 13.5, maxZ = 16},
            [30] = {coord = vector4(-3031.93, 592.9, 7.1, 198.04), height = 21.2, width = 4.2, heading = 198, minZ = 6.5, maxZ = 9},
            [31] = {coord = vector4(-2196.93, 4268.17, 47.89, 57.81), height = 21.2, width = 4.2, heading = 57, minZ = 47, maxZ = 49},
            [32] = {coord = vector4(-780.64, 5561.16, 32.88, 2.23), height = 21.2, width = 4.2, heading = 2, minZ = 32, maxZ = 34},
            [33] = {coord = vector4(-431.78, 6028.53, 30.75, 217.99), height = 21.2, width = 4.2, heading = 217, minZ = 30, maxZ = 32},
            [34] = {coord = vector4(-292.98, 6250.54, 30.7, 136.97), height = 21.2, width = 4.2, heading = 136, minZ = 30, maxZ = 32},
            [35] = {coord = vector4(-139.88, 6387.0, 30.8, 312.71), height = 21.2, width = 4.2, heading = 312, minZ = 30, maxZ = 32},
            [36] = {coord = vector4(-22.59, 6518.94, 30.72, 131.4), height = 21.2, width = 4.2, heading = 131, minZ = 30, maxZ = 32},
            [37] = {coord = vector4(92.29, 6401.41, 30.65, 221.5), height = 21.2, width = 4.2, heading = 221, minZ = 30, maxZ = 32},
            [38] = {coord = vector4(1584.68, 6441.85, 24.44, 65.66), height = 21.2, width = 4.2, heading = 65, minZ = 24, maxZ = 26},
            [39] = {coord = vector4(1470.29, 6360.55, 23.14, 140.87), height = 21.2, width = 4.2, heading = 140, minZ = 22.5, maxZ = 25},
            [40] = {coord = vector4(1661.79, 4852.79, 41.31, 187.61), height = 21.2, width = 4.2, heading = 187, minZ = 40.5, maxZ = 43},
            [41] = {coord = vector4(1799.12, 4585.58, 36.43, 6.05), height = 21.2, width = 4.2, heading = 6, minZ = 35.5, maxZ = 38},
            [42] = {coord = vector4(2502.57, 4098.76, 37.63, 154.2), height = 21.2, width = 4.2, heading = 154, minZ = 36.5, maxZ = 39},
            [43] = {coord = vector4(1995.11, 3775.61, 31.59, 34.58), height = 21.2, width = 4.2, heading = 34, minZ = 30.5, maxZ = 33},
            [44] = {coord = vector4(1621.1, 3586.07, 34.55, 31.62), height = 21.2, width = 4.2, heading = 31, minZ = 33.5, maxZ = 36},
            [45] = {coord = vector4(1399.91, 3596.58, 34.3, 109.07), height = 21.2, width = 4.2, heading = 109, minZ = 33.5, maxZ = 36},
            [46] = {coord = vector4(341.9, 2630.62, 43.91, 292.84), height = 21.2, width = 4.2, heading = 292, minZ = 43, maxZ = 45},
            [47] = {coord = vector4(592.44, 2737.12, 41.44, 5.2), height = 21.2, width = 4.2, heading = 5, minZ = 40.5, maxZ = 43},
            [48] = {coord = vector4(1137.53, 2664.75, 37.42, 357.43), height = 21.2, width = 4.2, heading = 357, minZ = 37, maxZ = 39},
            [49] = {coord = vector4(1854.76, 2585.9, 45.08, 177.39), height = 21.2, width = 4.2, heading = 177, minZ = 44.5, maxZ = 47},
        },
    },    
